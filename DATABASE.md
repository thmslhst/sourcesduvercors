...
-- We reference its user table; app-specific profile fields (display_name) live there
-- via Better Auth's additionalFields rather than a parallel profile table.
